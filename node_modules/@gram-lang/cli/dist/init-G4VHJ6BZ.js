...
var DB_TEMPLATE = `# Gram ingredient database
      ...
      if (provider !== "ollama") {
        ...
        if (saveKey) {
          ...
          if (apiKey) {
            ...
            const envKey = AI_PROVIDER_ENV_VAR[provider];
